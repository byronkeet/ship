		...
		<section className='bg-neutral text-neutral-content'>
			<div className='max-w-7xl mx-auto px-8 py-16 md:py-32 text-center'>
				...
				<div className='flex flex-col md:flex-row justify-center items-center md:items-start gap-6 md:mb-8'>
					<Step
						emoji='🧑‍💻'
						text='Hours trying to create the perfect thumbnail'
					/>
					...
					<Step
						emoji='😮‍💨'
						text='Wasting creativity time on a single image'
					/>
					...
					<Step
						emoji='😔'
						text='Quit posting your content'
					/>
				</div>
				...
				<div className={"btn-gradient p-3 rounded"}>
					...
					<div className='flex flex-col md:flex-row justify-center items-center md:items-start gap-6'>
						<Step
							emoji='🧑‍🎨'
							text='Rapidly generate multiple amazing thumnails'
						/>
						...
						<Step
							emoji='🫰'
							text='Generate powerful thumbnails in a snap'
						/>
						...
						<Step
							emoji='🚀'
							text='Strap your viewership to a rocket'
						/>
					</div>
					<div>
						<ButtonSignin
							extraStyle='btn-primary'
							text={"Create your Thumbnail Free"}
						/>
					</div>
				</div>
			</div>
